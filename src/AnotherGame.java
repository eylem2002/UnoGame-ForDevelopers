...
class AnotherGame extends Game {
    public AnotherGame(List<Player> players) {
        super(players);
    }
    ...
    protected void skipNextPlayer() {
        Collections.rotate(players, clockwise ? -3 : 3);//skip two players
        System.out.println("Clip hands");
    }
    ...
    protected void handleWildCard() {
        ...
        System.out.println("close ur eyes");
        Scanner scanner = new Scanner(System.in);
